> **⚠️ 本手册已被 v2 取代(2026-07-23)**:现行实验室在 `/Users/camellia/Personal/Code/claude/seed-kit-evals-v2`,手册见 `/Users/camellia/Personal/Code/claude/seed-kit-evals-v2/EVALS.md`,日常命令 `seed-evals doctor / sentinel / value`。以下内容仅适用于旧仓库 seed-kit-evals(v1),供历史参照。
