...
- Implementation Shape / 实现形态:
  - 参考形态: <贴近哪些 repo / framework 既有页面、组件、service、API、测试或运行时子系统>
  - 组装方式: <功能如何由页面 / 组件 / API / service / 状态 / 数据层组合完成>
...
- [ ] Technical Framing 覆盖 stack/auth/实现形态/责任归属/事实源/data/admin/integration/testing/migration 等承重边界；N/A 项已明确
