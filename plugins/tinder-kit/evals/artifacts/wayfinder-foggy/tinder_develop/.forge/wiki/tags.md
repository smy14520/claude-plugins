...
-->
- `im-integration`: 公司 IM（企业微信/钉钉/飞书）开放平台对接：消息推送、OAuth 登录、任务/日历 API (_Avoid_: wecom, dingtalk, feishu, wechat-work, 机器人)
...
-->
- `external-api`: 第三方开放平台/外部系统 API 对接：端点、鉴权、限流与准入门槛 (_Avoid_: third-party, openapi, open-platform)
