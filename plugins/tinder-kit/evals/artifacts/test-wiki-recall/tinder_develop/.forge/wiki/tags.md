...
- `cli`: 命令行交互、参数解析与子命令设计 (_Avoid_: command-line, terminal)
- `error-handling`: 错误码、stderr 输出与失败路径约定 (_Avoid_: exceptions, errors)
- `formatting`: CLI 输出格式约定（列表、前缀、日期展示）(_Avoid_: display, output-format)
